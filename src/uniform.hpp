...
private:
  std::string _name;                       // Name of the uniform variable
  ShaderProgram *_shaderProgram = nullptr; // Pointer to shader program this uniform belongs to
  GLint _location = -1;                    // OpenGL assigned uniform location (cached in this variable)
};
